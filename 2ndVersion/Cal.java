...
public class Cal extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //阶乘函数"！"
        Button jiecheng = new Button("x!");
        jiecheng.prefHeightProperty().bind(mainPane.heightProperty().divide(5));
        jiecheng.prefWidthProperty().bind(mainPane.widthProperty().divide(6));
        jiecheng.setFont(Font.font("Times New Roman",
                FontWeight.BOLD, FontPosture.ITALIC, 12));
        jiecheng.styleProperty().bind(
                Bindings
                        .when(jiecheng.hoverProperty())
                        .then(
                                new SimpleStringProperty("-fx-color: #4f7aa2;")
                        )
                        .otherwise(
        ...
        Button ln = new Button("lnX");
        ln.prefHeightProperty().bind(mainPane.heightProperty().divide(5));
        ln.prefWidthProperty().bind(mainPane.widthProperty().divide(6));
        ln.setFont(Font.font("Times New Roman",
                FontWeight.BOLD, FontPosture.ITALIC, 12));
        ln.styleProperty().bind(
                Bindings
                        .when(ln.hoverProperty())
                        .then(
                                new SimpleStringProperty("-fx-color: #4f7aa2;")
                        )
                        .otherwise(
        ...
        equal.prefWidthProperty().bind(mainPane.widthProperty().divide(4));
        ...
        pi.prefWidthProperty().bind(mainPane.widthProperty().divide(6));
        ...
        E.prefHeightProperty().bind(mainPane.heightProperty().divide(5));
        E.prefWidthProperty().bind(mainPane.widthProperty().divide(6));
        E.setFont(Font.font("Times New Roman",
                FontWeight.BOLD, FontPosture.ITALIC, 12));
        E.styleProperty().bind(
                Bindings
                        .when(E.hoverProperty())
                        .then(
                                new SimpleStringProperty("-fx-color: #f4a54d;")
                        )
                        .otherwise(
        ...
        //次方函数"x^y"
        Button cifang = new Button("10^y");
        cifang.prefHeightProperty().bind(mainPane.heightProperty().divide(5));
        cifang.prefWidthProperty().bind(mainPane.widthProperty().divide(6));
        cifang.setFont(Font.font("Times New Roman",
                FontWeight.BOLD, FontPosture.ITALIC, 12));
        cifang.styleProperty().bind(
                Bindings
                        .when(cifang.hoverProperty())
                        .then(
                                new SimpleStringProperty("-fx-color: #4f7aa2;")
                        )
                        .otherwise(
        ...
        //倒数 "1/x"函数
        Button daoshu = new Button("1/x");
        daoshu.prefHeightProperty().bind(mainPane.heightProperty().divide(5));
        daoshu.prefWidthProperty().bind(mainPane.widthProperty().divide(6));
        daoshu.setFont(Font.font("Times New Roman",
                FontWeight.BOLD, FontPosture.ITALIC, 12));
        daoshu.styleProperty().bind(
                Bindings
                        .when(daoshu.hoverProperty())
                        .then(
                                new SimpleStringProperty("-fx-color: #4f7aa2;")
                        )
                        .otherwise(
        ...
        //水平框 hBox1  用于存放数字7，8，9  以及 除法运算符'／' 删除回退键 '<-' 重置键 正弦'sin' 反正弦'sinh' 阶乘x!
        ...
        hBox1.getChildren().addAll(num7, num8, num9, div, backSpace, home, sin, sinh,jiecheng);

        //水平框 hBox2  用于存放数字4，5，6   以及乘法运算符  左右括号  余弦 反余弦 10的次方
        ...
        hBox2.getChildren().addAll(num4, num5, num6, mul, b1, b2, cos, cosh,cifang);
        ...
        hBox3.getChildren().addAll(num1, num2, num3, sub, xPower2, sqrt, tan, tanh,daoshu);

        //水平框 hBox4   用于存放 点 数字0 % +  = pi e ln
        ...
        hBox4.getChildren().addAll(num0, dot, sum,mod,ln,pi,E,equal);
        ...
        cifang.setOnMouseClicked(e -> {
            exp = textField.getText();
            String exp1=exp;
            int m=(int)Double.parseDouble(exp);
            m =(int)Math.pow(10,m);
            exp=Double.toString(m);
            textField.setText(exp);
        ...
        equal.setOnMouseClicked(e -> {
            try {//String [] Expression=exam.divide(exp);
                //  history[indexof]=exp;
                //  indexof++;
              /*
    		   ...
    		   */
                ...
                showResultProcess.setText(ss);
                res = true;
                x2 = false;} catch (NullPointerException eed) {} catch (NumberFormatException eed) {
            }
        });
        ...
        ln.setOnMouseClicked(e -> {
            double m =Double.parseDouble(exp);
            ss+="ln"+exp;
            double result=0.0;
            if(m<0) textField.setText("error");
            else
                result = Math.log(m);
            exp=Double.toString(result);
            textField.setText(exp);
        ...
        save.setOnMouseClicked(
                e ->
                {
                    File f = new File("c:\\result.txt"); //创建拖出的文件
